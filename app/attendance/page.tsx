    ...
    return (
        <LayoutWrapper>
            <div className="p-4 w-full mx-auto space-y-6">
                {/* Tabs */}
                <div className="flex p-1.5 gap-2 bg-gray-100/50 dark:bg-slate-900/50 rounded-2xl w-fit border border-gray-200/50 dark:border-slate-800 backdrop-blur-md">
                    <button
                        onClick={() => setActiveTab('ATTENDANCE')}
                        className={`py-3 px-6 font-black text-sm rounded-xl transition-all flex items-center gap-2 shadow-sm ${activeTab === 'ATTENDANCE' ? 'bg-white dark:bg-slate-800 text-[var(--theme-primary)] shadow-md border border-gray-100 dark:border-slate-700' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}
                    >
                        <CalendarIcon /> Attendance
                    </button>
                    <button
                        onClick={() => setActiveTab('LEAVE')}
                        className={`py-3 px-6 font-black text-sm rounded-xl transition-all flex items-center gap-2 shadow-sm ${activeTab === 'LEAVE' ? 'bg-white dark:bg-slate-800 text-[var(--theme-primary)] shadow-md border border-gray-100 dark:border-slate-700' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}
                    >
                        <StatusIcon status="Pending" /> Leave Management
                    </button>
                    <button
                        onClick={() => setActiveTab('ATTENDANCE_MASTER')}
                        className={`py-3 px-6 font-black text-sm rounded-xl transition-all flex items-center gap-2 shadow-sm ${activeTab === 'ATTENDANCE_MASTER' ? 'bg-white dark:bg-slate-800 text-[var(--theme-primary)] shadow-md border border-gray-100 dark:border-slate-700' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}
                    >
                        <UserIcon /> Attendance Master
                    </button>
                    <button
                        onClick={() => setActiveTab('REPORT')}
                        className={`py-3 px-6 font-black text-sm rounded-xl transition-all flex items-center gap-2 shadow-sm ${activeTab === 'REPORT' ? 'bg-white dark:bg-slate-800 text-[var(--theme-primary)] shadow-md border border-gray-100 dark:border-slate-700' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}
                    >
